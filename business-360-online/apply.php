...
<head>
	...
	<link rel="stylesheet" type="text/css" href="assets-data/css/style_new.css?v=0.0.2">
...
<div class="wrapper">
		<div class="container">
			<header class="header">
				<div class="row">
				  <div class="col-sm-6">
					 <a href="https://emeritus.gsb.columbia.edu/business-360-online/index.php" target="_blank" onclick="trackEvent('click','B360 LP','Redirect','Partner Logo')"><img src="assets-data/images/logo.png" alt="Columbia Business School" title="Columbia Business School"> </a>
				  </div>
				</div>
			</header>
		</div>
					...
					<div id="2" class="col-md-5 form-div no_pad">
						<form class="contact-form">
							<div class="text-center thakyou-outer">
								<p class="thankyou">It's not too late to join 7200+ student from 120+ countries who have already taken our courses</p>
								<p class="getintouch">Application Deadline: 25th April 2018<br/>Program Starts: 26th April 2018</p>
								<div class="text-center">
								<p style="padding:2% 0;"><a style="display: block; margin: 0 auto;width: 144px;text-decoration:none ! important;border-color:#b8434f;" class="btn btn-default download-btn-link" href="http://bit.ly/2GqGWJo" target="_blank"> APPLY NOW</a></p>
								</div>
							</div>
						</form>
					</div>
