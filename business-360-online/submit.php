...
<body>
<center>
	<img src="assets-data/images/ajax-loader.gif" class="loading, please wait..."/>
</center>
...
?>
<form class="form-horizontal mCustomScrollbar" role="form" id="frm" name="frm" action="https://www2.emeritus.org/l/134351/2018-03-23/3jzkvw" method="post">
<input type="hidden" name="retURL" value="https://emeritus.gsb.columbia.edu/business-360-online/<?php echo $thankyoupage;?>">
