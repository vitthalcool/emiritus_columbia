...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/style_newv.css?v=0.0.5">
	<link rel="stylesheet" type="text/css" href="css/responsive_newv.css?v=0.0.4">
...
<body>
	<div class="wrapper">
		<div class="container-fluid" id="header">
			<div class="container">
				<header class="header no-padd">
					<div class="row">
					  <div class="col-sm-6 nav-left-logo no-padd">
		...
		<div class="header-topic">
			<div class="container no-padd">
				<h1 class="main-title">Value Investing (Online): <br/>Making Intelligent Investment Decisions</h1>
			</div>	
		</div>
		
		<div class="container df vedio-section">
			<div class="col-md-7 no_pad banner-item">
			...
			<div id="2" class="col-md-5 form-div form-section banner-item">
...
function resetVideo()
{
	 ...
	 jQuery(".banner-item").css('height','auto');
	 jQuery(".banner-item iframe#player").css('height','auto');
	 if ($(window).width() > 768) 
	 {
		 jQuery(".banner-item").each(function(){
			if (jQuery(this).height() > maxHeight) { maxHeight = jQuery(this).height(); }
		 });
		 jQuery(".banner-item iframe#player").height(maxHeight);
		 jQuery(".banner-item").height(maxHeight);
	  ...
	  $('#country').change(function(){
		resetVideo();
		setTimeout(function () {resetVideo();},1);
		});
</script>
