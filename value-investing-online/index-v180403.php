			...
			<div class="col-md-4 col-sm-4 no_pad">
				...
				<div class="info-box clearfix">
					...
					<div class="img-content">
						...
						<h6 class="info">
							<a href="javascript:void(0)" onclick="trackEvent('click','CBSVI LP','Pop Up','Price-Flexi')" data-toggle="modal" data-target="#myModal"> <img src="images/info_icon.png" alt="info" title="info" class="">&nbsp;<i class="bm">Avail Flexible Payment</i></a>
						</h6>
