			...
			<div class="col-md-4 col-sm-4 no_pad">
				...
				<div class="info-box clearfix">
					...
					<div class="img-content">
						...
						<h6>
							<a href="javascript:void(0)" onclick="trackEvent('click','CBSVI LP','Redirect','Price-Flexi')" class="" data-toggle="modal" data-target="#myModal"><i><span class="info">i</span>&nbsp;<u>Avail flexible payment</u></i></a>
						</h6>
