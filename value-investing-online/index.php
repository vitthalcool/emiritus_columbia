...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/style_new.css?v=0.0.6">
			...
			<div class="banner-bg1">
				...
				<div class="container df">
					...
					<div id="2" class="col-md-5 form-div no_pad form-section">
							...
							<form class="form-horizontal contact-form form-bg" role="form" id="frm" name="frm" method="POST" action="submit.php" novalidate="novalidate">
								...
								<div id="fields">
									...
									<div class="form-group">
										...
										<div class="col-sm-12">
											...
											<input type="submit" class="btn btn-default download-btn w100" value="DOWNLOAD BROCHURE >"/>
									...
									<input type="hidden" name="matchtype" value="<?php echo htmlspecialchars($_GET['matchtype']);?>">

									<input type="hidden" name="network" value="<?php echo htmlspecialchars($_GET['network']);?>">

									<input type="hidden" name="creative" value="<?php echo htmlspecialchars($_GET['creative']);?>">

									<input type="hidden" name="keyword" value="<?php echo htmlspecialchars($_GET['keyword']);?>">

									<input type="hidden" name="placement" value="<?php echo htmlspecialchars($_GET['placement']);?>">

									<input type="hidden" name="random" value="<?php echo htmlspecialchars($_GET['random']);?>">

									<input type="hidden" name="copy" value="<?php echo htmlspecialchars($_GET['copy']);?>">

									<input type="hidden" name="adposition" value="<?php echo htmlspecialchars($_GET['adposition']);?>">
			...
			<div class="col-md-4 col-sm-4 no_pad">
				...
				<div class="info-box clearfix">
					...
					<div class="img-content">
						...
						<h6 class="info">
							<a href="#" onclick="trackEvent('click','CBSVI LP','Pop Up','Price-Flexi')" data-toggle="modal" data-target="#myModal"> <img src="images/info_icon.png" alt="info" title="info" class="">&nbsp;<i class="bm">Avail Flexible Payment</i></a>
						</h6>
