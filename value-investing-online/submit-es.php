...
{
	header("Location: index-es.php?err=1");
	exit;
}
else if($csrf != $_SESSION["viestoken"])
{
	header("Location: index-es.php?err=1");
	exit;
}*/
...
?>
<form class="form-horizontal mCustomScrollbar" role="form" id="frm" name="frm" action="http://www2.emeritus.org/l/134351/2018-04-17/3rlh9t" method="post">
...
<input type="hidden" id="work_experience" name="work_experience" value="<?php echo html_entity_decode($workexp, ENT_COMPAT, 'UTF-8');?>">
