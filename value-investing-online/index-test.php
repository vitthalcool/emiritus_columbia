			...
			<div class="banner-bg">
				<div class="container df">
					...
					<div id="2" class="col-md-5 form-div no_pad form-section">
							<form class="form-horizontal contact-form" role="form" id="frm" name="frm" method="POST" action="submit-test.php" novalidate="novalidate">
								...
								<div id="fields">
									...
									<div class="form-group">
										...
										<div class="col-sm-12">
											...
											<p><small>Your details will not be shared with third parties.</small></p>

											<p><strong><small><a href="//emeritus.org/privacy-policy/" target="_blank">Privacy Policy</a></small></strong></p>
...
<script src="https://eim.mit.edu/assets/js/countries-new.js?v=0.0.1"></script>
<script> 
