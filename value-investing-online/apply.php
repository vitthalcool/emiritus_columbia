	...
	<div class="wrapper">
				...
				<header class="header">
					<div class="row">
					  <div class="col-sm-6 nav-left-logo">
						 <a href="" onclick="trackEvent('click','CBSVI LP','Redirect','Partner Logo')" class="svg" alt="Columbia Business School" title="Columbia Business School">
					...
					<div id="2" class="col-md-5 form-div no_pad">
							<form class="contact-form">
								<div class="text-center thakyou-outer">
									<p class="thankyou">It's not too late to join 7200+ students from 120+ countries who have already taken our programs.</p>
									<p class="getintouch">Application Deadline: May 2, 2018<br/>Program Starts: May 3, 2018</p>
									<div class="text-center">
									<p style="padding:2% 0;"><a style="display: block; margin: 0 auto;width: 144px;text-decoration:none ! important;border-color:#b8434f;" class="btn btn-default download-btn-link" href="http://bit.ly/2GuUyPC" target="_blank"> APPLY NOW</a></p>
									<p style="padding:2% 0;"><i>Want to know more about the program? <a href="https://zoom.us/recording/play/G7xNDo6AlDNIUWAlLZFr1apWZ0hIwVUy-dVBBIEKdrOaPLRz3gvXq75F_oRjYyfV" target="_blank" style="text-decoration:underline !important;">Click here</a> to view  the information session about Value Investing (Online).</i></p>
									</div>
								</div>
							</form>
					</div>
		...
		<div class="container info-row">
			...
			<div class="col-md-4 col-sm-4 no_pad">
				<div class="info-box clearfix">
					<div class="img-holder">
						<img src="images/fee.png" alt="Program Fees" title="Program Fees">
					</div>
					<div class="img-content">
						<h3>program fees</h3>
						<p>$3,750</p>
		...
		<div class="container padtop">
					...
					<div class="content-wrapper">
						...
						<div class="row clearfix">
							<div class="col-md-6 col-sm-6">
								<div class="syllabus">
									<ul>
										<li><span class="ul-head">Module 1:</span> Value Investment<br/> Foundations, framework, and introduction to asset value: Overview of the valuation approach and calculating asset value.
										</li>
										<li><span class="ul-head">Module 2:</span> Earnings Power Value<br/> The methodology to identify and buy securities prices well below their true value</li>
										...
										<li><span class="ul-head">Module 4:</span> Magna International Case Study<br/> Valuation exercise for automotive marketing in the aftermath of the financial crisis</li>
									</ul>
								</div>
							</div>
			...
			<div class="container">
				...
				<div class="row p-50 container-row">
					<div class="mb92">
						<p class="text-left datatext padd-lf">We apply concepts by valuing real companies through case studies from Walmart, Amazon, Intel, John Deere, and others. And we’ll tackle highly-debated topics like: When does growth create value? How can we measure competitive advantage? How should we value risk?
						</p>
					</div>
					...
					<div class="col-md-4 col-sm-4 col-xs-12 load_more_show">
						<div class="alumni_featured">
    						<div class="alumni_featured_image" align="left">
								<img src="images/mgn.png" alt="Magna" title="Magna" class="img-responsive">
							</div>
							<div class="alumni_featured_band triangle-down">
    						    <h5 class="alumni_featured_name">Magna</h5>
								 <p class="alumni_featured_data">
					...
					<div class="col-md-12 col-sm-12 col-xs-12 text-right loadm">
						<a href="" onclick="trackEvent('click','CBSVI LP','Open','Load More')" class="load_more" id="loadMore">Load more</a>
					</div>
		...
		<div class="top-footer">
			<div class="text-center">
				...
				<h5>Flexible payment options available. <a href="#" onclick="trackEvent('click','CBSVI LP','Redirect','Flexi Pay')" class="applynow" data-toggle="modal" data-target="#myModal">Click here</a> to know more.</h5>
			</div>
		</div>
          ...
          <div class="modal-body">
            ...
            <h5>The following payment options are available for the <i class="data-program">Value Investing (Online) </i><i>program</i>.</h5>
				...
				<ul class="ul_style">Pay in 2 installments</ul>
					...
					<li>The second installment of <b>$1,760</b> will be charged on <b>May 21, 2018</b>
					</li>
				</ul>
				...
				<ul class="ul_style">Pay in 3 installments</ul>
					...
					<li>The second installment of <b>$1,181</b> will be charged on <b>May 21, 2018</b>
					</li>
					<li>The third installment of <b>$1,181</b> will be charged on <b>June 14, 2018</b>
					</li>
				</ul>
            </div>
    </div>
...
<script>
$('#pardot-form input[type="submit"]').click(function(){
	trackEvent('click','CBSVI V3 LP','FormSubmit','Form_Submit');
});
</script>
